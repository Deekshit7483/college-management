...
public class AttendenceActivity extends AppCompatActivity {
	...
	private DatabaseReference attendance = _firebase.getReference("attendance");
	private ChildEventListener _attendance_child_listener;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		_attendance_child_listener = new ChildEventListener() {
			@Override
		...
		attendance.addChildEventListener(_attendance_child_listener);
	...
	public class Listview1Adapter extends BaseAdapter {
		...
		public View getView(final int _position, View _v, ViewGroup _container) {
			...
			View _view = _v;
			if (_view == null) {
				_view = _inflater.inflate(R.layout.attendance, null);
			}
