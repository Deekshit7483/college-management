	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button_continue.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				fauth.sendPasswordResetEmail(tx_email.getText().toString()).addOnCompleteListener(_fauth_reset_password_listener);
			}
		});
		...
		_fauth_reset_password_listener = new OnCompleteListener<Void>() {
			...
			public void onComplete(Task<Void> _param1) {
				final boolean _success = _param1.isSuccessful();
				if (_success) {
					SketchwareUtil.showMessage(getApplicationContext(), "password reset link is sent ");
				}
				else {
					SketchwareUtil.showMessage(getApplicationContext(), "password reset link is not sent!! ");
				}
			}
		};
	}
