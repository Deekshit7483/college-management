		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (edittext2.getText().toString().equals("")) {
					SketchwareUtil.showMessage(getApplicationContext(), "Username");
				}
				else {
					if (edittext3.getText().toString().equals("")) {
						SketchwareUtil.showMessage(getApplicationContext(), "Email");
					}
					else {
						if (edittext4.getText().toString().equals("")) {
							...
							key = contact.push().getKey();
							map = new HashMap<>();
							map.put("name", edittext2.getText().toString());
							map.put("email", edittext3.getText().toString());
							map.put("message", edittext4.getText().toString());
							map.put("key", key);
							map.put("uid", FirebaseAuth.getInstance().getCurrentUser().getUid());
							contact.child(key).updateChildren(map);
							map.clear();
							finish();
						}
					}
