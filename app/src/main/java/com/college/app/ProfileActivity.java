...
public class ProfileActivity extends AppCompatActivity {
	...
	private LinearLayout Editusername;
	private LinearLayout editregister;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		save.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				editregister.setVisibility(View.GONE);
		...
		imageview5.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				SketchwareUtil.showMessage(getApplicationContext(), "You can't edit profile");
			}
		});
		...
		_user_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childKey.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
					...
					textview3.setText(_childValue.get("register number").toString());
					textview4.setText(_childValue.get("dob").toString());
					textview5.setText(_childValue.get("number").toString());
					textview6.setText(_childValue.get("email").toString());
				}
			}
	...
	private void initializeLogic() {
		...
		edittext8.setVisibility(View.GONE);
		save.setVisibility(View.GONE);
		_setcornerradius(Editusername, 20, 1, "#EEEEEE");
		_setcornerradius(editregister, 20, 1, "#EEEEEE");
		_setcornerradius(save, 20, 1, "#EEEEEE");
	}
	...
	protected void onActivityResult(int _requestCode, int _resultCode, Intent _data) {
		...
		switch (_requestCode) {
			...
			if (_resultCode == Activity.RESULT_OK) {
				...
				circleimageview2.setImageBitmap(FileUtil.decodeSampleBitmapFromPath(_filePath.get((int)(0)), 1024, 1024));
